...
Core es el host ejecutable del frontend. Contiene Vite, la entrada HTML, el montaje React, el shell PWA y la infraestructura compartida. Los módulos funcionales, como Tareas, viven como hermanos y no poseen servidor ni instalación propia.
...
npm test
npm run build
node ../tareas/tests/core_dom.mjs
node ../tareas/tests/v2_dom.mjs mock
node ../tareas/tests/v2_dom.mjs
node ../tareas/tests/v2_live.mjs
```
