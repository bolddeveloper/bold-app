...
export const adminApi = {
    ...
    createOrganizationOption: body => http.request("/api/v2/administration/organization-options/", { method: "POST", body }),
    updateOrganizationOption: (id, body) => http.request(`/api/v2/administration/organization-options/${id}/`, { method: "PATCH", body }),
    deleteOrganizationOption: id => http.request(`/api/v2/administration/organization-options/${id}/`, { method: "DELETE" }),
