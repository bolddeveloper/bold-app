    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="boldApp_core.grantauthority",
                    ),
                ),
                (
                    "permission",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="grant_authority_links",
                        to="boldApp_core.permission",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="permission_audit_logs",
                        to="boldApp_core.positionassignment",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(("id", models.F("parent_unit")), _negated=True),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("job_role", "permission"), name="unique_job_role_permission"
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("id", models.F("reports_to_position")), _negated=True
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["employee", "is_active"], name="idx_posasg_employee_active"
            ),
        ),
        migrations.AddIndex(
            model_name="permissionauditlog",
            index=models.Index(
                fields=["employee", "created_at"], name="idx_permauditlog_emp_created"
            ),
        ),
        migrations.AddIndex(
            model_name="accessgrant",
            index=models.Index(
                fields=["grantee_assignment", "status"],
                name="idx_accessgrant_grantee_status",
            ),
        ),
    ]
